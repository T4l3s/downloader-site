...
<form action="/searchfilter.php" class="w3-container w3-card-4 w3-light-grey">
   <center> <h2> Coloque seu link aqui</h2> </center>

  <p>
  <input required="" class="w3-input w3-border w3-round-large" name="s" type="text"></p>
  <center>
   <button type="submit" class="w3-bar-item w3-button w3-red" > Pesquisar! </button></center>
   <br><br>
</form>
...
<div class="footer">
  ...
  <p> © All right Reserved 2021 . Powered By <b> Taleszito :) </b> </p>
</div>
  <p></p>
</div>
